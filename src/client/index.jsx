...
function FeishuSection({ t, createSession, sessionTitles }) {
  ...
  return h('div', { style: pageStyle },
    ...
    h('div', { style: cardStyle },
      ...
      h('div', { style: lineStyle },
        h('span', { style: labelStyle }, t('rowVersion')),
        h('span', { style: { ...valueStyle, fontFamily: 'ui-monospace, SFMono-Regular, Consolas, monospace', fontSize: 12 } },
          status !== null && status.version ? String(status.version) : '…'),
      ),
    ),
    // Credentials card
    h('div', { style: cardStyle },
