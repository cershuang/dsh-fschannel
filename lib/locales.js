...
export const zh = {
  ...
  // send_feishu_file tool
  sendFileNoSession: '无法确定当前会话，文件未发送',
  sendFileUnbound: '当前会话未绑定飞书聊天，文件未发送',
  sendFileNoPath: '请提供文件路径',
  sendFileOutsideWorkspace: '文件路径必须在会话工作区内',
  sendFileNotFound: '文件不存在或为空',
  sendFileTooLarge: '文件超过 30 MiB 上限，未发送',
  sendFileSent: '文件已发送到飞书聊天',
  sendFileFailed: '文件发送失败，请稍后重试',
}
...
export const en = {
  ...
  sendFileNoSession: 'Cannot determine the current session; the file was not sent',
  sendFileUnbound: 'The current session is not bound to a Feishu chat; the file was not sent',
  sendFileNoPath: 'Provide the file path',
  sendFileOutsideWorkspace: 'The file path must stay inside the session workspace',
  sendFileNotFound: 'File does not exist or is empty',
  sendFileTooLarge: 'File exceeds the 30 MiB limit; not sent',
  sendFileSent: 'File sent to the Feishu chat',
  sendFileFailed: 'File send failed; please try again later',
}
